...
struct RecipeFeaturedView: View {
    ...
    //   the key in the sortDescriptor is the string "name" because it sorts it based on the name of the whatever.apple for some examples
    //   if you forget the predicate formats, you can use google them in developer.apple, or just goolge a cheatsheet
...
//        RecipeFeaturedView(recipe: <#FetchRequest<Recipe>#>)
